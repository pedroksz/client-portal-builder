      ...
      <div className="flex-1 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-sm max-w-none text-muted-foreground space-y-4">
            ...
            <h3 className="text-primary font-semibold mt-2">1. Aceitação dos Termos</h3>
            <p>
            ...
            <h3 className="text-primary font-semibold mt-6">2. Serviços Oferecidos</h3>
            ...
            <h3 className="text-primary font-semibold mt-6">3. Cadastro e Acesso</h3>
            <p>
            ...
            <h3 className="text-primary font-semibold mt-6">4. Responsabilidades do Cliente</h3>
            ...
            <h3 className="text-primary font-semibold mt-6">5. Pagamentos e Cobrança</h3>
            <p>
            ...
            <h3 className="text-primary font-semibold mt-6">6. Propriedade Intelectual</h3>
            <p>
            ...
            <h3 className="text-primary font-semibold mt-6">7. Confidencialidade</h3>
            <p>
            ...
            <h3 className="text-primary font-semibold mt-6">8. Limitação de Responsabilidade</h3>
            <p>
            ...
            <h3 className="text-primary font-semibold mt-6">9. Rescisão</h3>
            <p>
            ...
            <h3 className="text-primary font-semibold mt-6">10. Modificações nos Termos</h3>
            <p>
            ...
            <h3 className="text-primary font-semibold mt-6">11. Lei Aplicável e Foro</h3>
            <p>
              Estes termos são regidos pelas leis da República Federativa do Brasil. Fica eleito o 
              foro da comarca de São Paulo/SP para dirimir quaisquer questões decorrentes destes termos.
            </p>

            <h3 className="text-primary font-semibold mt-6">12. Contato</h3>
            <p>
